    ...
    <>
      ...
      <div className="h-screen">
        <img
          ...
          className="text-center mx-auto 2xl:w-[900px] lg:h-[500px] lg:object-cover 2xl:mt-8 2xl:h-[600px]"
          alt=""
        />
        <div className="w-[150px] mx-auto">
          <Link href="/">
            <p className=" bg-blue-600 text-center text-white px-2 py-1 cursor-pointer w-[150px]">
              Về trang chủ
            </p>
          </Link>
        </div>
